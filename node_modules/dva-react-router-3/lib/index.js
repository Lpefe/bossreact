...
var _hashHistory = _interopRequireDefault(require("react-router/lib/hashHistory"));
...
function _default() {
  ...
  var history = opts.history || _hashHistory.default;
  var createOpts = {
    initialReducer: {
    ...
    setupApp: function setupApp(app) {
      app._history = patchHistory((0, _reactRouterRedux.syncHistoryWithStore)(history, app._store));
    }
  };
