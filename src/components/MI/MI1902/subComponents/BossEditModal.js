...
import {Button, Cascader, Checkbox, DatePicker, Form, Input, InputNumber, Modal, Radio, Select, Switch ,Divider} from 'antd';
                            ...
                            case "CheckBox":
                                return <FormItem {...item.customerFormLayout ? item.customerFormLayout : modalFormLayout}
                                    ...
                                    {getFieldDecorator(item.valName || index, {
                                        ...
                                        <Checkbox {...item.nativeProps}>{item.checkBoxName}</Checkbox>
                                    )}
                                </FormItem>;
                            case "CheckboxGroup":
                                return <FormItem {...item.customerFormLayout ? item.customerFormLayout : modalFormLayout}
                                    ...
                                    {getFieldDecorator(item.valName || index, {
                                        ...
                                        <CheckboxGrp {...item.nativeProps} options={item.children}/>
                                    )}
                                </FormItem>;
                            default:
                                return ""
