...
class ISPModal extends React.Component {
    ...
    render() {
        ...
        return <Modal maskClosable={false} visible={this.props.visible} title={__(messages["ISP配置"])} onCancel={this.props.cancel} width={700} size="small"
                      bordered footer={null}>
